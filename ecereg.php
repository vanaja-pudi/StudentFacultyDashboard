...
<section>
  <div class="leftside"> 
	<div class="div_container">
		<div class="outer">
			<form class="box" action="eup.php" method="POST">
				  <h3>SIGNUP</h3>
				       <input type="text" name="eid" placeholder="Enter Idno"><br><br>
			<input type="text" name="epn" placeholder="Enter name"><br><br>
            <select name="eclass">
                        <option value="ece-1">ece-1</option>
                          ...
                          <option value="ece-6">ece-6</option>
            </select><br><br>
             <input type="password" name="epd" placeholder="********"><br><br>
            <input type="password" name="ecpd" placeholder="confirm password"><br><br>
			<select name="equestion" required>
			...
			<input type="text" name="eanswer" placeholder="Enter answer"><br><br>
