...
$_SESSION["id"]=$sid;
$spd=$_POST['spd'];
$did=$con->query("select * from elearner where eid='$sid'");
...
if($did->num_rows>0)
{
	...
	if($spd==$pdFromDb)
	{
				...
				<br><br><br>
					...
					<a href="fac.html"id="tag"><i class="fa fa">Faculty</i></a>
							...
							if($clDb==$cl||$clDb=='all')
							{
								?>
									<tr >
										...
										<td><h5 data-target="#<?php echo $rowDb['sno'];?>" data-toggle="modal" ><?php echo $rowDb["title"]; if(($timeDiff/86400)<3){echo'&nbsp;<img src="newgif.gif" width="40px" height="30px">";';}?></h5></td>
