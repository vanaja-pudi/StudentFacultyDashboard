...
<section>
  ...
  <div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive" id="tableDb">
		<table class= "table table-bordered  mb-0"id="student_data"style="border:5px solid gray;overflow-x:hidden;">
					...
					while($result=$msgs->fetch_array())
					{
						...
						<tr>
							<td style="color:white; font-size:15px;" ><h4><?php echo $result['msg'];
								...
								if($actExt[2]!='')
								{
									?><a href="<?php echo $result['file'];?>" target="_blank" style="text-transform:none;color:white;"download>Download</a><img src="newgif.gif" width="40px" height="30px"><?php
								}
								else{echo'';}?></h4></td>
						</tr><?php
					}?>
