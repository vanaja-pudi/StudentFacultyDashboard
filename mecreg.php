...
<section>
  <div class="leftside"> 
	<div class="div_container">
		<div class="outer">
			<form class="box" action="mup.php" method="POST">
				  <h3>SIGNUP</h3>
				       <input type="text" name="mid" placeholder="Enter Idno"><br><br>
			<input type="text" name="mpn" placeholder="Enter name"><br><br>
            <select name="mclass">
                        <option value="me-1">me-1</option>
                          <option value="me-2">me-2</option>
            </select><br><br>
             <input type="password" name="mpd" placeholder="********"><br><br>
            <input type="password" name="mcpd" placeholder="confirm password"><br><br>
			<select name="mquestion" required>
			...
			<input type="text" name="manswer" placeholder="Enter answer"><br><br>
  ...
  <div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive" id="tableDb">
		<table class= "table table-bordered  mb-0"id="student_data"style="border:3px solid gray;overflow-x:hidden;">
			...
			NOTIFICATIONS TO ALL</th></tr>
				...
				<?php
					include 'mainphp.php';
					$msgs=$con->query("select *from malerts where section='all' order by sno desc");
					session_start();
